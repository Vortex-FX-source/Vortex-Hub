...
if Sea2 or Sea3 then
    ...
    QuestsTabs:AddToggle({Name = "Auto Dragon Talon", Callback = function(Value)
        ...
        task.spawn(function()
            local MasteryDragonClaw = 0; local FireEssence = false
            local function GetProxyNPC()
                local Distance = math.huge; local NPC = nil
                local plrChar = Player and Player.Character and Player.Character.PrimaryPart
                for _,npc in pairs(Enemies:GetChildren()) do
    ...
    QuestsTabs:AddToggle({Name = "Auto Superhuman", Callback = function(Value)
        getgenv().AutoSuperhuman = Value
        task.spawn(function()
            local MasteryBlackLeg = 0; local MasteryElectro = 0; local MasteryFishmanKarate = 0; local MasteryDragonClaw = 0; local MasterySuperhuman = 0
            local function GetProxyNPC()
                local Distance = math.huge; local NPC = nil
                local plrChar = Player and Player.Character and Player.Character.PrimaryPart
                for _,npc in pairs(Enemies:GetChildren()) do
    ...
    QuestsTabs:AddToggle({Name = "Auto God Human", Callback = function(Value)
        ...
        task.spawn(function()
            ...
            local MasteryBlackLeg = 0; local MasteryElectro = 0; local MasteryFishmanKarate = 0; local MasteryDragonClaw = 0; local MasterySuperhuman = 0
            local MasteryElectricClaw = 0; local MasteryDragonTalon = 0; local MasterySharkmanKarate = 0; local MasteryDeathStep = 0; local MasteryGodHuman = 0
    ...
    if Sea3 then
        ...
        table.insert(AFKOptions, QuestsTabs:AddToggle({Name = "Auto Mastery All Fighting Style", Callback = function(Value)
            ...
            task.spawn(function()
                ...
                local MasteryBlackLeg = 0; local MasteryElectro = 0; local MasteryFishmanKarate = 0; local MasteryDragonClaw = 0; local MasterySuperhuman = 0
                local MasteryElectricClaw = 0; local MasteryDragonTalon = 0; local MasterySharkmanKarate = 0; local MasteryDeathStep = 0; local MasteryGodHuman = 0; local MasterySanguineArt = 0
